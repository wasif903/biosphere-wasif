...
export default function Home() {
  ...
  useEffect(() => {
    if (swiper) {
      ...
      swiper.navigation.destroy(); // Destroy default navigation
      swiper.navigation.init(); // Initialize custom navigation
  ...
  const handleButtonClick = async () => {
    ...
    if (Object?.keys(errors_)?.length === 0) {
      // console.log('All fields are valid, proceed with action');
    ...
    <StoreLayout>
      ...
      <div className="flex flex-col gap-5 mt-5">
        ...
        <div className="w-full h--[20rem] relative">
          {/* <div className="custom-button prev" ref={prevRef}>     || nextButtonText === 'Submit'
            {prevButtonText}
          </div> */}
