  ...
  return (
    <StoreLayout>
      <div className="w-full h-full flex gap-5">
        <div className="bg-white box_shadow_sec w-[25rem] max-lg:w-full h-full p-2 rounded-lg">
        ...
        <div className="bg-white box_shadow_sec w-full rounded-lg p-3 max-lg:hidden">
